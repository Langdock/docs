...
<Tip>Use the **usage insights** of your assistant to view quantitative analytics and review qualitative feedback you received from users. You find the usage insights by clicking on the three dots in the top right corner</Tip>