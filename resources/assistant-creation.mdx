...
![](/images/create-assistant-1.png)

## Instructions

The most important part of the assistant configuration is to give the right instructions. You can use the [prompt engineering guide](/resources/prompt-elements) to craft good instructions. The prompt elements (persona, task, context, format) especially help to define what the assistant should do.
...
![](/images/create-assistant-2.png)

![](/images/create-assistant-3.png)
...
![](/images/create-assistant-7.png)

## Capabilities

At the bottom, you can enable different capabilities the assistant should use. These are web search, image generation and data analysis. These tools are explained in detail in the guide about our chat [here](/product/chat-tools). In our case, the assistant will not need these capabilities. If the assistant does not need the capabilities, we can turn them off.

![](/images/create-assistant-8.png)

## Assistant actions

Actions are a custom capability you can give your assistant. They are an API connection to other tools and allow the assistant to retrieve information, update, delete or create entries in other tools. You can find out more about actions in [this guide](/settings/integrations/create-actions).

![](/images/create-assistant-9.png)
...
![](/images/create-assistant-10.png)
...
![](/images/create-assistant-11.png)

![](/images/create-assistant-12.png)
