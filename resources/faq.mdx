...
| File Type        | File Extension | File Size Limit |
|------------------|----------------|-----------------|
| Excel / Google Sheets | .xlsx, .xls | 30 MB          |
| CSV              | .csv           | 30 MB           |

Tabular files can only be uploaded in chat and assistants, not in knowledge folders.
...
Images can only be uploaded in chat, not in knowledge folders and assistants.

**Audio Files**
| File Type        | File Extension | File Size Limit |
|------------------|----------------|-----------------|
| Audio/Video Transcription | .mp3, .wav, .ogg | 200 MB |

Audio files can only be uploaded in chat, not in knowledge folders and assistants.
