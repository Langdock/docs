...
In this part you will find a step by step example on how to build and deploy your first custom assistant within Langdock's Assistant Builder. 

Let's create an HR Assistant. 

### Launch the Assistant Configurator ###
<img src="/images/createAssistant.png" width="350" height="275"/>
### Give your assistant a name, a description, and set an icon ###
<img src="/images/nameAndDescription.png" width="350" height="275"/>
### Give your assistant custom instructions ###
