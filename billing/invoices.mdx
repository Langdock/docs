...
_Number of users x price per seat_

For example:

_9 users x € 20 EUR = € 180_
...
_Section 1 price + Section 2 price = Total amount_

_Price of the current month + Price of the next month = Total amount_

_= [Price for 1 license for 15 days + Price for 2 licenses for 8 days] + Price for the next month = Total amount_

_= [ ( € 67.74 - € 58.06 ) + ( € 40.65 - € 31.61 ) ] + € 180  = € 198.72_
