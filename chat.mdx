...
## Image analysis
In Langdock, you can process uploaded images and analyze them. Ensure you select GPT-4 in the model selection (upper left corner of the chat interface). A third button will appear at the bottom of the chat input field called “Image”. Here, you can upload images.
