...
- Sending a direct message to the **@Langdock** app.

<img src="/images/slack-bot-1.png" />

After tagging **@Langdock** or messaging it directly, the bot will respond in a thread and you can choose either the default model or an Assistant that should respond to your message.
