...
To choose a model for your next response, switch it in the top left corner of the chat. Each model has its characteristics. You can learn more about the current models in Langdock in our [model guide](/resources/models).
...
If you want to reuse a prompt, save it by clicking the “+” icon. You need to choose a folder where you want to save your prompt in the prompt library and give your prompt a name. You can learn more about the prompt library [here](/product/chat/prompt-library).
