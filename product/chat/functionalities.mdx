---
title: 'Chat functionalities'
description: 'Apart from the tools you can steer with your written input, you can use a few other functionalities to work in the chat. These are the model selector in the top left corner and the buttons to interact with prompts and responses.'
---
