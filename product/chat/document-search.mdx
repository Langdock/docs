...
If you attach a document to a chat, the document search tool will automatically be used. Document search extracts text from files, such as PDFs, Word documents, or PowerPoint presentations. You will find a list of all supported file types [here](/resources#which-file-types-does-langdock-support).
