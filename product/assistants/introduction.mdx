...
description: 'Assistants are chatbots you can set up for a specific use case or to work with a specific document. It works similarly to the chat, with the difference that you save documents and instructions to refer to the assistant without setting the chat up again.'
---
