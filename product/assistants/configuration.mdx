...
<Tip>For more details you can read our detailed [assistant creation guide](/resources/assistant-creation) of how to build an assistant.</Tip>
...
Choose the model this assistant will use. For details about choosing the right model, you can refer to our [model guide](/resources/models).
...
Enable or disable different tools that are connected to the AI model, like [web search]((/product/chat/web-search), [image generation]((/product/chat/image-generation), or [data analysis]((/product/chat/data-analysis).

### Actions

Actions are API calls that assistant can execute to retrieve, update, create or delete information in other tools. Find out how to set up actions in [this guide](/settings/integrations/create-actions).
