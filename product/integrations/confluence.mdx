...
2. Open the settings and check if “Verify private listings” and “Enable Development Mode” is checked. If not, check the boxes and click “Apply”. The development mode is only temporary, Langdock is currently in Atlassian’s verification process.
...
12. Click on "Find installed Langdock App"

13. Click “Save” in the Confluence set up in Langdock.
