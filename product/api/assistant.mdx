...
<Info>
  ...
  settings](https://app.langdock.com/settings/workspace/products/api). If you
  want to interact with an existing Assistant, make sure to "Share" access to
  the assistant with the created API Key (Assistants > Your Assistant > Share).
</Info>
