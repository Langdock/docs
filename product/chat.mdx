...
**Uploading files from your computer:** Click on the paperclip in the left end of the chat input field. Your computer's finder opens and you can select the according files you want to upload to the chat. You can also drag and drop files or paste them with CMD + V (Mac) or CNTRL + V (Windows).to either upload files or select files from your connected integrations.

**Selecting files from connected integrations:** To use files from your integrations, also click on the paperclip in the left end of the chat input field. A search bar opens with which you can search for the according files. This search searched through all integrations, so if you have Confluence and Google Drive connected both of these apps are searched for the most fitting results. Files are sorted by relevance (how often you used them in Langdock and how recently they have been edited) to show the most relevant results for you.
