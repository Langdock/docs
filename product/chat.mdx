...
### Image Analysis Mode ###
In Langdock, you can process uploaded images and analyze them. Ensure you select GPT-4o or one of the Claude models in the model selection field (upper left corner of the chat interface). You can upload PNG or JPG files by clicking on the paper clip in the left corner of the chat input field.
...
Each model has its own unique strengths, and we encourage you to explore and test different models to find the best fit for your needs. Find out about different models [here](/models). 
