...
## General
The general workspace includes the most important customizations of the workspace. You can upload your company logo here, give the tool an adequate name, and enter a short description. This description is sent to the model with all prompts for every workspace user (like the custom instructions on a user level). Here, you also find the option to delete the workspace.
