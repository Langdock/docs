...
## Subscription
The subscription page shows the plan you are currently on and the other plans Langdock offers. For details and a pricing calculator, refer to our [pricing page](https://www.langdock.com/pricing) on our website. We have written a [guide here](/admin/invoices) if you have any questions regarding invoices.
...
<Info>You can find guides for SSO, SAML and SCIM [here](/settings/security). If you have any questions, please reach out to support@langdock.com.</Info>
...
<Warning> The different roles refer to the permissions in the [Roles](/settings/workspace##user-management###roles) section below. A **workspace editor is not the same as an assistant editor** and can only edit assistants when the editing access is explicitly given to them.</Warning>

### Groups
Assistants and prompts in the prompt library can be shared with the entire workspace (if this permission is set, see the [Roles section](/settings/workspace##user-management###roles) below) or with specific groups. This allows, for example, the marketing team to share a SEO copywriting prompt with marketing colleagues or the engineering team to share a coding assistant with fellow developers.
...
To exclusively use your models, please refer to [this guide about BYOK](/settings/byok) (bring your own keys).
