...
## Setup
### 1. Creating assistant and its instructions
...
````
### 2. OpenAPI Schema
Scroll to the bottom of the assistant configuration and click on **New Action**. Here you can configure actions and API requests to other tools. Copy the text below into the field **OpenAPI Schema**.
...
1. Copy the callback URL from the OAuth section in the action
