...
1. Click on **New connected app** and then on **Create an External Client App** with OAuth 2.0.

![](/images/actions-sf-3.png)

1. Enter a name for your app, e.g. “Langdock”

2. Enter your email address as the contact email

3. Enable OAuth by checking the according box

4. Add a callback URL placeholder. This can be any URL and will be updated at the end.

![](/images/actions-sf-4.png)

1. Select the permissions in **Selected OAuth Scopes** you want to grant this app and the assistant. This should be comply with your internal security guidelines.

2. Check these boxes (if they are not checked already):
...
3. Uncheck this box (if it is checked):
...
3. Go to **OAuth Policies** and check this box:
...
1. Finish the setup by clicking **Save**
