...
1. Hover over **Select file**. A search bar opens with which you can search for the according files.

![](/images/Chat_Search_Integrations.png)

1. Click the file you want to use in the chat to attach it to your prompt. Enter your prompt to work with the document (e.g. `Summarize the attached document`)
...
3. You can now either continue to the original file you found and open it in a new tab or use the file in a Langdock chat to e.g. summarize it, ask questions about it etc.