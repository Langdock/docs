...
* [Personal Integrations Guide](/settings/integrations/oauth)

**Workspace Integrations**:

* [Google Drive Workspace Integration](/settings/integrations/google-drive)

* [Confluence Workspace Integration](/settings/integrations/confluence)
...
For setting up the Slack bot, you can refer to [this guide](/settings/integrations/slack) and how to use it is explained [here](/settings/integrations/how-to-use-slack).

We will add more apps here in the next weeks, beginning with Microsoft Teams!

## Action integrations in assistants

[Assistant actions](/settings/integrations/creating-actions) are a powerful functionality to connect any app with an assistant. We have prepared a detailed guide for setting this up [here](/resources/actions-assistant)
...
* [Salesforce actions](/settings/integrations/actions-salesforce)

* [Google Drive actions](/settings/integrations/actions-google-drive)

* [Jira actions](/settings/integrations/actions-jira)

Please contact us at [support@langdock.com](mailto:support@langdock.com) for any questions or support!