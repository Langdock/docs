...
## Search Integrations
Search integrations are native integrations in Langdock, built by us, so that you just have to connect your app. These integrations use APIs of other apps and users can search files in Chats, Assistants and in Search. We have explained how they work in [this guide](../how-to-use-search-integrations).
...
[Assistant actions](../../product/assistants/actions) are a powerful functionality to connect any app with an assistant. We have prepared a detailed guide for setting this up [here](../../resources/actions-assistant)
...
- [Zapier actions](../settings/integrations/actions-zapier)
