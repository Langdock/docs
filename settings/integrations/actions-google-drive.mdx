...
---
## Prerequisits
This guide helps you to set up an assistant action for Google Drive. Before proceeding, we recommend reading the following guide: [Assistant actions](https://docs.langdock.com/product/assistants/actions).
