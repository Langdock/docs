---
title: "How to use and set up Actions"
description: "Actions allow you to integrate any tool through an API to an assistant. This gives you a vera large range of opportunities. Below you find a short introduction of how to use it."
---
...
We have created an assistant, which you can find [here](https://docs.langdock.com/resources/actions-assistant). Simply paste the API documentation into the chat field, and the assistant will build the Open API schema for this endpoint. You might need to change a few details like the URL to fit your app.
