...
2.  Open the settings and check if **Verify private listings** and **Enable Development Mode** is checked. If not, check the boxes and click “Apply”. The development mode is only temporary, while the Langdock app is being verified by Atlassian.
    ...
    <img
      src="/images/confluence-app-import-3.png"
      alt="Enable Development mode and private listings"
    />

3.  Refresh the page so that the **Upload App** button appears.

    <img
      src="/images/confluence-app-import-4.png"
      alt="Confluence App Overview"
    />
...
5.  Press **Upload** to add the Langdock app to Confluence. The success screen looks like this:
    <img
      src="/images/confluence-app-import-6.png"
      alt="Confluence Langdock App created"
    />
...
8. Enter a name to identify the API key (e.g. “Langdock API key”) and define an expiry date.
   ...
   By default, the key expires one week from today. If you’d like to change the expiration
...
11. Click on **Find installed Langdock App** and click **Save**.

12. Click **Done** in the admin menu of Confluence to close the API key window. Make sure you have copied the API keys as they can not be shown again.
