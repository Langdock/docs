...
To push files to the knowledge folder, you can use the API of the folder. You can request an API key from [support@langdock.com](mailto:support@langdock.com). You can find the API schema in the [following guides](/settings/knowledge-folders/upload-a-file-to-a-knowledge-folder). The current rate limit is 50 requests per minute.