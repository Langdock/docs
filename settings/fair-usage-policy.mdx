...
## Implementation
If a user exceeds the allowed limits, they can switch to a different model. However, 95% of all users never hit this limit, and the limit is only temporary.
