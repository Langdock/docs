...
For instance, phrases like `It's crucial that I get this right for my thesis defense` or `This is very important to my career` can activate parts of the model that lead to more accurate and detailed responses. 
