...
**Prompt without instructions:** <br />`Tell me about space.`

**Prompt with instructions:** <br /> `Provide a brief overview of the solar system, including the names and key characteristics of each planet.`
