...
_Example:_
<br /> `Search the attached documents for information about office guidelines in our Berlin office.` 
<br /> `Then, list relevant items as bullet points and sort them by importance.`
<br /> `Afterwards, write a piece of concise information to post on our company's Slack channel to remind everyone about the 10 most important things to remember.`
